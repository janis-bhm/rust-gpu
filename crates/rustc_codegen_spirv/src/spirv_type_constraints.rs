...
pub fn instruction_signatures(op: Op) -> Option<&'static [InstSig<'static>]> {
    ...
    match op {
        ...
        // SPV_EXT_mesh_shader
        Op::EmitMeshTasksEXT => sig! {(T, T, T, ..)},
        Op::SetMeshOutputsEXT => sig! { (T, T) },
        Op::ImageSampleWeightedQCOM
        | Op::ImageBoxFilterQCOM
        | Op::ImageBlockMatchSSDQCOM
        | Op::ImageBlockMatchSADQCOM
        | Op::ImageBlockMatchSADQCOM => {
            reserved!(SPV_QCOM_image_processing);
        }
        Op::ColorAttachmentReadEXT => todo!(),
        Op::DepthAttachmentReadEXT => todo!(),
        Op::StencilAttachmentReadEXT => todo!(),
        Op::GroupNonUniformRotateKHR => todo!(),
        // spirv 1.6
        Op::UDot | Op::SUDot | Op::SDot => sig! { (Vector(T), Vector(T), _) -> T },
        Op::SDotAccSat | Op::UDotAccSat | Op::SUDotAccSat => {
            sig! { (Vector(T), Vector(T), T) -> T }
        }
        Op::TypeCooperativeMatrixKHR => todo!(),
        Op::CooperativeMatrixLoadKHR => todo!(),
        Op::CooperativeMatrixStoreKHR => todo!(),
        Op::CooperativeMatrixMulAddKHR => todo!(),
        Op::CooperativeMatrixLengthKHR => todo!(),
        Op::FinalizeNodePayloadsAMDX => todo!(),
        Op::FinishWritingNodePayloadAMDX => todo!(),
        Op::InitializeNodePayloadsAMDX => todo!(),
        Op::HitObjectRecordHitMotionNV => todo!(),
        Op::HitObjectRecordHitWithIndexMotionNV => todo!(),
        Op::HitObjectRecordMissMotionNV => todo!(),
        Op::HitObjectGetWorldToObjectNV => todo!(),
        Op::HitObjectGetObjectToWorldNV => todo!(),
        Op::HitObjectGetObjectRayDirectionNV => todo!(),
        Op::HitObjectGetObjectRayOriginNV => todo!(),
        Op::HitObjectTraceRayMotionNV => todo!(),
        Op::HitObjectGetShaderRecordBufferHandleNV => todo!(),
        Op::HitObjectGetShaderBindingTableRecordIndexNV => todo!(),
        Op::HitObjectRecordEmptyNV => todo!(),
        Op::HitObjectTraceRayNV => todo!(),
        Op::HitObjectRecordHitNV => todo!(),
        Op::HitObjectRecordHitWithIndexNV => todo!(),
        Op::HitObjectRecordMissNV => todo!(),
        Op::HitObjectExecuteShaderNV => todo!(),
        Op::HitObjectGetCurrentTimeNV => todo!(),
        Op::HitObjectGetAttributesNV => todo!(),
        Op::HitObjectGetHitKindNV => todo!(),
        Op::HitObjectGetPrimitiveIndexNV => todo!(),
        Op::HitObjectGetGeometryIndexNV => todo!(),
        Op::HitObjectGetInstanceIdNV => todo!(),
        Op::HitObjectGetInstanceCustomIndexNV => todo!(),
        Op::HitObjectGetWorldRayDirectionNV => todo!(),
        Op::HitObjectGetWorldRayOriginNV => todo!(),
        Op::HitObjectGetRayTMaxNV => todo!(),
        Op::HitObjectGetRayTMinNV => todo!(),
        Op::HitObjectIsEmptyNV => todo!(),
        Op::HitObjectIsHitNV => todo!(),
        Op::HitObjectIsMissNV => todo!(),
        Op::ReorderThreadWithHitObjectNV => todo!(),
        Op::ReorderThreadWithHintNV => todo!(),
        Op::TypeHitObjectNV => todo!(),
        Op::FetchMicroTriangleVertexPositionNV => todo!(),
        Op::FetchMicroTriangleVertexBarycentricNV => todo!(),
        Op::ReportIntersectionKHR => todo!(),
        Op::TraceMotionNV => todo!(),
        Op::TraceRayMotionNV => todo!(),
        Op::RayQueryGetIntersectionTriangleVertexPositionsKHR => todo!(),
        Op::TypeAccelerationStructureKHR => todo!(),
        Op::DemoteToHelperInvocation => todo!(),
        Op::ConvertUToImageNV => todo!(),
        Op::ConvertUToSamplerNV => todo!(),
        Op::ConvertImageToUNV => todo!(),
        Op::ConvertSamplerToUNV => todo!(),
        Op::ConvertUToSampledImageNV => todo!(),
        Op::ConvertSampledImageToUNV => todo!(),
        Op::SamplerImageAddressingModeNV => todo!(),
        Op::AsmTargetINTEL => todo!(),
        Op::AsmINTEL => todo!(),
        Op::AsmCallINTEL => todo!(),
        Op::AtomicFMinEXT => todo!(),
        Op::AtomicFMaxEXT => todo!(),
        Op::AssumeTrueKHR => todo!(),
        Op::ExpectKHR => todo!(),
        Op::VariableLengthArrayINTEL => todo!(),
        Op::SaveMemoryINTEL => todo!(),
        Op::RestoreMemoryINTEL => todo!(),
        Op::ArbitraryFloatSinCosPiINTEL => todo!(),
        Op::ArbitraryFloatCastINTEL => todo!(),
        Op::ArbitraryFloatCastFromIntINTEL => todo!(),
        Op::ArbitraryFloatCastToIntINTEL => todo!(),
        Op::ArbitraryFloatAddINTEL => todo!(),
        Op::ArbitraryFloatSubINTEL => todo!(),
        Op::ArbitraryFloatMulINTEL => todo!(),
        Op::ArbitraryFloatDivINTEL => todo!(),
        Op::ArbitraryFloatGTINTEL => todo!(),
        Op::ArbitraryFloatGEINTEL => todo!(),
        Op::ArbitraryFloatLTINTEL => todo!(),
        Op::ArbitraryFloatLEINTEL => todo!(),
        Op::ArbitraryFloatEQINTEL => todo!(),
        Op::ArbitraryFloatRecipINTEL => todo!(),
        Op::ArbitraryFloatRSqrtINTEL => todo!(),
        Op::ArbitraryFloatCbrtINTEL => todo!(),
        Op::ArbitraryFloatHypotINTEL => todo!(),
        Op::ArbitraryFloatSqrtINTEL => todo!(),
        Op::ArbitraryFloatLogINTEL => todo!(),
        Op::ArbitraryFloatLog2INTEL => todo!(),
        Op::ArbitraryFloatLog10INTEL => todo!(),
        Op::ArbitraryFloatLog1pINTEL => todo!(),
        Op::ArbitraryFloatExpINTEL => todo!(),
        Op::ArbitraryFloatExp2INTEL => todo!(),
        Op::ArbitraryFloatExp10INTEL => todo!(),
        Op::ArbitraryFloatExpm1INTEL => todo!(),
        Op::ArbitraryFloatSinINTEL => todo!(),
        Op::ArbitraryFloatCosINTEL => todo!(),
        Op::ArbitraryFloatSinCosINTEL => todo!(),
        Op::ArbitraryFloatSinPiINTEL => todo!(),
        Op::ArbitraryFloatCosPiINTEL => todo!(),
        Op::ArbitraryFloatASinINTEL => todo!(),
        Op::ArbitraryFloatASinPiINTEL => todo!(),
        Op::ArbitraryFloatACosINTEL => todo!(),
        Op::ArbitraryFloatACosPiINTEL => todo!(),
        Op::ArbitraryFloatATanINTEL => todo!(),
        Op::ArbitraryFloatATanPiINTEL => todo!(),
        Op::ArbitraryFloatATan2INTEL => todo!(),
        Op::ArbitraryFloatPowINTEL => todo!(),
        Op::ArbitraryFloatPowRINTEL => todo!(),
        Op::ArbitraryFloatPowNINTEL => todo!(),
        Op::AliasDomainDeclINTEL => todo!(),
        Op::AliasScopeDeclINTEL => todo!(),
        Op::AliasScopeListDeclINTEL => todo!(),
        Op::FixedSqrtINTEL => todo!(),
        Op::FixedRecipINTEL => todo!(),
        Op::FixedRsqrtINTEL => todo!(),
        Op::FixedSinINTEL => todo!(),
        Op::FixedCosINTEL => todo!(),
        Op::FixedSinCosINTEL => todo!(),
        Op::FixedSinPiINTEL => todo!(),
        Op::FixedCosPiINTEL => todo!(),
        Op::FixedSinCosPiINTEL => todo!(),
        Op::FixedLogINTEL => todo!(),
        Op::FixedExpINTEL => todo!(),
        Op::PtrCastToCrossWorkgroupINTEL => todo!(),
        Op::CrossWorkgroupCastToPtrINTEL => todo!(),
        Op::TypeBufferSurfaceINTEL => todo!(),
        Op::TypeStructContinuedINTEL => todo!(),
        Op::ConstantCompositeContinuedINTEL => todo!(),
        Op::SpecConstantCompositeContinuedINTEL => todo!(),
        Op::ConvertFToBF16INTEL => todo!(),
        Op::ConvertBF16ToFINTEL => todo!(),
        Op::ControlBarrierArriveINTEL => todo!(),
        Op::ControlBarrierWaitINTEL => todo!(),
        Op::GroupIMulKHR => todo!(),
        Op::GroupFMulKHR => todo!(),
        Op::GroupBitwiseAndKHR => todo!(),
        Op::GroupBitwiseOrKHR => todo!(),
        Op::GroupBitwiseXorKHR => todo!(),
        Op::GroupLogicalAndKHR => todo!(),
        Op::GroupLogicalOrKHR => todo!(),
        Op::GroupLogicalXorKHR => todo!(),
    }
